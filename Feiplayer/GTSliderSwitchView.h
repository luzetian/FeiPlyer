//
//  LTSliderSwitchView.h
//  navigationDome
//
//  Created by lynd on 14-2-19.
//  Copyright (c) 2014年 lynd. All rights reserved.
//

#import <UIKit/UIKit.h>
@protocol GLSliderSwitchViewDelegate;
@interface GTSliderSwitchView : UIView<UIScrollViewDelegate>
{
    ...
    __weak id<GLSliderSwitchViewDelegate> _slideSwitchViewDelegate;
}
...
@property (nonatomic, weak) IBOutlet id<GLSliderSwitchViewDelegate> slideSwitchViewDelegate;
...
@protocol GLSliderSwitchViewDelegate <NSObject>
 ...
 * @result
 */
- (void)slideSwitchView:(GTSliderSwitchView *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
